...
exports.webSocket = (socket, io) => {
   ...
   socket.on("createRoom", (data) => listRoom.push({ ...data, socketIDUserCreate: socket.id ,member:[]}));
   ...
   socket.on("joinRoom", ({ room, userID }) => {
      ...
      socket.on("fetch-data-request", (room) => {
         ...
         io.to(room).emit("fetch-data-to-client", { drawData, layer: layer.numLayer, layerStorage });
      });
